...
(function () {
  ...
  function renderTimeline() {
    ...
    const onListDrop = (e) => {
      ...
      // (those use the same dataTransfer type, so we look at the dragged
      // element's class to disambiguate).
      // Simplest heuristic: timeline row drag start sets a global flag.
