...
(async () => {
  ...
  // loads a lot of `<script defer>` tags). Give the module a moment to
  // attach SWR_NARRATIVE to the window before we evaluate.
  await page.waitForFunction('typeof window.SWR_NARRATIVE !== "undefined"', { timeout: 10000 });
